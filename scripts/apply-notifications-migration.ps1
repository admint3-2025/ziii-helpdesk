...
Write-Host "  Migración: Sistema de Notificaciones  " -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "=====================================" -ForegroundColor Green
Write-Host ""
Write-Host "✓ Tabla 'notifications' creada" -ForegroundColor Gray
Write-Host "✓ Triggers automáticos configurados:" -ForegroundColor Gray
...
Write-Host "✓ Supabase Realtime habilitado" -ForegroundColor Gray
Write-Host "✓ Políticas de seguridad (RLS) aplicadas" -ForegroundColor Gray
Write-Host ""
Write-Host "=====================================" -ForegroundColor Magenta
Write-Host "  SIGUIENTE PASO                    " -ForegroundColor Magenta
Write-Host "=====================================" -ForegroundColor Magenta
Write-Host ""
Write-Host "Después de ejecutar la migración, reinicia el servidor de desarrollo:" -ForegroundColor White
Write-Host "  npm run dev" -ForegroundColor Cyan
Write-Host ""
Write-Host "El ícono de campana aparecerá en el header con notificaciones en tiempo real." -ForegroundColor Yellow
Write-Host ""
